...
| **Melhor Média Geral** | `0.9656` (Média Geral Aprovada no Gate >= 0.8) |
| **Métrica Crítica F1-Score** | Elevada de `0.48` (Base) para `0.96` (Final) |
...
| **F1-Score** | 0.48 | **0.96** | 0.80 | ✅ APROVADO |
| **Clarity** | 0.50 | **0.95** | 0.80 | ✅ APROVADO |
| **Precision** | 0.46 | **0.98** | 0.80 | ✅ APROVADO |
| **Média Geral** | 0.48 | **0.9656** | 0.80 | ✅ APROVADO |
...
<details>
<summary><b>🔍 Bug #6: Webhook de pagamento aprovado não está sendo chamado (Clique para abrir)</b></summary>

#### Trilha Geral (RunnableSequence)
![Trace do RunnableSequence](screenshots/bug_6_sequence.jpeg)

#### Formatação do Prompt (ChatPromptTemplate)
![Prompt Template](screenshots/bug_6_prompt_template.jpeg)

#### Resultado da Geração (ChatGoogleGenerativeAI)
![Resultado da Geração LLM](screenshots/bug_6_result.jpeg)

#### Avaliação de Métricas (Evaluators)
*   **Avaliador de Clareza (Clarity):**
    ![Avaliador de Clareza](screenshots/bug_6_eval_clarity.jpeg)
*   **Avaliador de Precisão (Precision):**
    ![Avaliador de Precisão](screenshots/bug_6_eval_precision.jpeg)
*   **Avaliador de F1-Score:**
    ![Avaliador de F1-Score](screenshots/bug_6_eval_f1.jpeg)

</details>

<details>
<summary><b>🛒 Bug #11: Carrinho permite finalizar compra mesmo com produto fora de estoque (Clique para abrir)</b></summary>

#### Trilha Geral (RunnableSequence)
![Trace do RunnableSequence](screenshots/bug_11_sequence.jpeg)

#### Formatação do Prompt (ChatPromptTemplate)
![Prompt Template](screenshots/bug_11_prompt_template.jpeg)

#### Resultado da Geração (ChatGoogleGenerativeAI)
![Resultado da Geração LLM](screenshots/bug_11_result.jpeg)

#### Avaliação de Métricas (Evaluators)
*   **Avaliador de Clareza (Clarity):**
    ![Avaliador de Clareza](screenshots/bug_11_eval_clarity.jpeg)
*   **Avaliador de Precisão (Precision):**
    ![Avaliador de Precisão](screenshots/bug_11_eval_precision.jpeg)
*   **Avaliador de F1-Score:**
    ![Avaliador de F1-Score](screenshots/bug_11_eval_f1.jpeg)

</details>

<details>
<summary><b>🔄 Bug #15: App de produtividade offline-first com bugs de sincronização (Clique para abrir)</b></summary>

#### Trilha Geral (RunnableSequence)
![Trace do RunnableSequence](screenshots/bug_15_sequence.jpeg)

#### Formatação do Prompt (ChatPromptTemplate)
![Prompt Template](screenshots/bug_15_promp_template.jpeg)

#### Resultado da Geração (ChatGoogleGenerativeAI)
![Resultado da Geração LLM](screenshots/bug_15_result.jpeg)

#### Avaliação de Métricas (Evaluators)
*   **Avaliador de Clareza (Clarity):**
    ![Avaliador de Clareza](screenshots/bug_15_eval_clarity.jpeg)
*   **Avaliador de Precisão (Precision):**
    ![Avaliador de Precisão](screenshots/bug_15_eval_precision.jpeg)
*   **Avaliador de F1-Score:**
    ![Avaliador de F1-Score](screenshots/bug_15_eval_f1.jpeg)
